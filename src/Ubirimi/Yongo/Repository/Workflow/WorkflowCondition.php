...
class WorkflowCondition
{
    ...
    public function deleteByTransitionId($transitionId) {
        $q = 'delete from yongo_workflow_condition_data where workflow_data_id = ?';
    ...
    public function addConditionString($transitionId, $stringText) {
        $q = 'update yongo_workflow_condition_data set definition_data = CONCAT(definition_data, ?) where workflow_data_id = ? limit 1';
