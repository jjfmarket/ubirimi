...
?>
    <div style="background-color: #ffffff; border-radius: 5px; border: #CCCCCC 1px solid; padding: 10px; margin: 10px;">
        ...
        <div style="padding-top: 5px; color: #333333;font: 17px Trebuchet MS, sans-serif;white-space: nowrap;padding-bottom: 5px;text-align: left;padding-left: 2px;">
            <span>Worklog updated on <a style="text-decoration: none; "
                                        href="<?php echo $session->get('client/base_url') ?>/yongo/issue/<?php echo $issue['id'] ?>"><?php echo $issue['project_code'] ?>-<?php echo $issue['nr'] ?></a> </span><?php echo $issue['summary'] ?>
            <br />
        </div>
        ...
        <div>Date started: <?php echo $extraInformation['date_started']; ?></div>
        <div>Time Spent: <?php echo $extraInformation['time_spent']; ?></div>
        <div>Remaining Time: <?php echo $extraInformation['remaining_time']; ?></div>
