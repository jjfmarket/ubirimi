...
class UbirimiClient
{
    ...
    public function install($clientId) {
        ...
        UbirimiContainer::get()['repository']->get(SMTPServer::class)->add(
            ...
            UbirimiContainer::get()['default_smtp.from_email_address'],
            'UBR',
            SMTPServer::PROTOCOL_SECURE_SMTP,
            UbirimiContainer::get()['default_smtp.hostname'],
            UbirimiContainer::get()['default_smtp.port'],
            UbirimiContainer::get()['default_smtp.timeout'],
            UbirimiContainer::get()['default_smtp.tls'],
            UbirimiContainer::get()['default_smtp.username'],
            UbirimiContainer::get()['default_smtp.password'],
            1,
            $clientCreatedDate
        );
