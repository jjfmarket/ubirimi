...
<div style="font: Trebuchet MS, sans-serif; white-space: nowrap; padding-top: 5px;text-align: left;padding-left: 2px;">
    ...
    <br />
    <br />
    A new account has been set up for your <strong><?php echo $repoName ?></strong> SVN Repository.
    <br />
    ...
    <br />
    Repository URL: <?php echo $baseURL . '/svn/' . Util::slugify($clientData['id']) . '/' . Util::slugify($repoName) . '/trunk' ?>
    <br />
